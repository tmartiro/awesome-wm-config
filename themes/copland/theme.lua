...
local mytextclock = wibox.widget.textclock("<span font='Terminus 9'> </span>%a %d %b %R ")
...
-- Battery
local battery_time =  wibox.widget.textbox(markup.font("Terminus 10", "--"))
...
local batupd = lain.widget.bat({
    settings = function()
        ...
        battery_time.text = bat_now.time
